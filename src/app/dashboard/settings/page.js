      ...
      <div className="card mb-4 space-y-3">
        <div className="flex items-start justify-between gap-3">
          <div className="flex-1">
            ...
            <p className="text-[11px] text-gray-500 mt-0.5 leading-snug">
              Permite empleados con jornada rotativa en esta sucursal. El gerente planifica su horario semana a semana.
            </p>
          </div>
          <button
            type="button"
            onClick={() => F('mixedSchedule', { ...(cfg.mixedSchedule || {}), enabled: !cfg.mixedSchedule?.enabled })}
        ...
        {cfg.mixedSchedule?.enabled && (
          <div className="pt-3 border-t border-dark-border">
            <label className="label">Maximo de empleados rotativos permitidos</label>
            <div className="flex items-center gap-2">
              <input className="input flex-1" type="number" min="1" max="9999" placeholder="Ilimitado"
                ...
                onChange={e => {
                  ...
                  F('mixedSchedule', { ...(cfg.mixedSchedule || {}), maxRotating: parsed, unlimitedRotating: parsed == null })
                }}
              ...
              <label className="flex items-center gap-1.5 text-[11px] text-gray-400 whitespace-nowrap">
                <input type="checkbox" className="accent-brand-400"
                  ...
                  onChange={e => {
                    ...
                    F('mixedSchedule', { ...(cfg.mixedSchedule || {}), unlimitedRotating: unlim, maxRotating: unlim ? null : (cfg.mixedSchedule?.maxRotating || 1) })
                  }}
                />
                Ilimitados
              </label>
